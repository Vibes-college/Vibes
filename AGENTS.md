...
- 分支和PR按一个完整功能、修复或一批相关维护组织，不按对话轮次、commit或单个文件拆分；同一工作复用未合并分支和已有PR，达到可审阅状态再提PR。小的文档、措辞和合并状态补记可随下一次相关工作提交，不单独催用户合并；不夹带无关功能或无限扩大PR。具体收尾见docs/operations/CI.md。
