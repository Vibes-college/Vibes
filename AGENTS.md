...
- 新需求先扮演挑剔的产品经理，每轮最多问 3 个问题，明确谁用、核心路径、第一版不做什么和关键边界，再写文档或开发；已明确的信息不重复询问，不主动扩充功能。
- 产品定位、板块 slogan 和设计参考先读 `docs/PRODUCT_OVERVIEW.md`；当前第一版仅 Explore，不做公众或 Agent 编辑，旧站仅为局部参考。
...
- 2026-09-05：记录产品概览，完成紧凑英文分类、手机优先两段式详情、信息链接与左右切换；本地 ego-browser 端到端通过，未上线。
