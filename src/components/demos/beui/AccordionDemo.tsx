...
import { BouncyAccordion } from '../../beui/bouncy-accordion';
...
function BouncyAccordionPreview() {
  return (
...
export default function AccordionDemo() {
  return (
    <div className="beui-demo not-prose dark" data-article-interactive data-beui="AccordionDemo">
