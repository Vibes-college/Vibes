...
import { AnimatedBadge, type AnimatedBadgeStatus } from '../../beui/animated-badge';
...
export default function BadgeDemo() {
  return (
    <div className="beui-demo not-prose dark" data-article-interactive data-beui="BadgeDemo">
