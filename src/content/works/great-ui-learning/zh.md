...
本合集由 Vibes 组织学习说明，目前的独立案例来自 Great UI。每件保留原作、固定源码和许可，录屏用于观察参考；接到你的项目后仍需用真实内容与操作检查结果。
...
说明由 Vibes 编写。当前 Great UI 原作采用自定义许可，允许在应用和网站使用，限制整库再分发；具体来源和许可在每件案例中查看。
