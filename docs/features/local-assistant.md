...
code-revision: '374b14b4c2ae59b84bf1f2e5b1682cbfcb8e92355434c109a2dd1c034beecea3'
---
...
维护者在明确启用H或A1配置的隔离实验站，可以从Explore或作品页右下角打开原生Paseo，收起后继续阅读；普通构建没有助手入口，两者尚未成为正式交付候选。
...
A1图表实验站中，Mermaid代码先显示源码，点击“查看图表”才加载渲染器；下载失败后可重试，源码仍可阅读和复制。图表显示后使用原生缩放及“查看源码”操作，回到图表或收起助手再打开会复用已加载资源。该行为仅在A1验证，H旧产物的图表尚未验收。
