...
code-revision: 'b30dbeeb192cdce5eea91f794fddd81aba57feab2c4a6455d1ab4de664d11b81'
---
...
电脑端需启用听写并准备官方默认的本地英语模型。小窗只有输入框有文字才显示文字发送；空输入始终显示麦克风，不受当前焦点或曾经点击影响，清空文字立即恢复麦克风，仅有文章引用或其他附件也保留麦克风。点击麦克风后按浏览器提示授权并开始录音，不会因为打开助手而录音或弹出键盘。
