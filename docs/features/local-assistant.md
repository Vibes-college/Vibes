...
2026-09-20收起按钮的触摸焦点释放、普通及文章入口的键盘焦点返回，在加载前后共12项三浏览器专项通过；随后完整verify通过193项单元、389项浏览器及7项设备条件跳过，预算与产物检查通过。证据在`resources/evidence/018-great-ui-scale/release-2026-09-19`；协议fixture及手机模拟不代替真实Agent会话或iPhone验收。
