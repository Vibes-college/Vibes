...
code-revision: 'a37897361a8ee0c7833e9721336f35b2c1dfc72a7bde05a7f95a462ee65dd739'
---
...
《Vibe Coding 网页动效与交互》在普通目录中只显示一个[学习合集](great-ui-learning.md)。卡片显示合集身份、48件数量和当前作品，左右箭头切换轻量预览；当前作品名称进入对应详情，合集标题进入合集的八站路线与十类目录。学习顺序独立于封面顺序，同一标签页在目录、搜索和合集首屏间保留所选封面。关键词搜索仍覆盖每件作品的说明、目标和术语，子项不重复铺进普通浏览卡片。
