...
code-revision: 'cd77b003e7956a74cd3d62986fe0cb469c180f63c5d270c6c827a8bb8cfe0da9'
---
...
右下角“本地助手”按需打开官方聊天面板，连接自己的电脑并选择Paseo会话；首页不附带作品，详情可附带当前公开资料。完整路径见[使用本地助手](local-assistant.md)，普通浏览不加载其SDK。
