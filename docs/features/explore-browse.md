...
code-revision: '69d383a27533f5fe5cf0cbccd582d111e0e93ee30e34b9ee261b4e0093880258'
---
...
8. 需要自己的Agent帮忙时点右下角[本地助手](local-assistant.md)，按安装与配对说明连接电脑，再选择Chat或Build；未点击前不下载Paseo或建立助手连接。浏览、筛选和搜索仍可独立完成。
