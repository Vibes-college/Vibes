...
code-revision: '49c9af8402f44df282fc2b936accea07d2bbeeb8237f30a6ee8a45bafbe08530'
---
...
8. 需要自己的Agent帮忙时点右下角[本地助手](local-assistant.md)，按安装与配对说明连接电脑，在小窗交流，或展开后从原生菜单选择项目和历史会话；未点击前不下载Paseo或建立助手连接。浏览、筛选和搜索仍可独立完成。
