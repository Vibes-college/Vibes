...
code-revision: 'e94b58d3bfdb83b2e26689c5b4eafac451e1210eb3cda001eb04bdb987f4dbcb'
---
...
- [x] 纯Agent文案与已知流程声明分类为docs，混入脚本、网页、依赖、GitHub工作流或未知路径回退；2026-09-12本地范围分类测试通过。
