...
手机先展示完整概览，下滑进入折叠章节；桌面保留相同顺序，内容最大宽 780px。方向按钮、左右键和手机横向手势切换相邻作品。`src/styles/detail.css` 与 `src/scripts/detail.ts` 负责此部分。2026-09-05 ego-browser 验收 320px 无横向溢出，390px 手机与 1280px 桌面截图已核对。
