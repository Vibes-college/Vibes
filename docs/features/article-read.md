...
code-revision: 'df6d5380b0306cdc85ed6abf1e47197c8c77df88256014f60705a8e1511c4799'
---
...
3. 上下滑动或点轻微摆动的向下入口，接近概览或正文入口时辅助对齐，轻滑不强制翻到下一屏，允许停在中间；正文全部展开；进入正文超过32px后关闭入口吸附，底部继续滑动保持普通滚动，回到入口附近恢复停靠。底部进度胶囊只在正文出现，显示阅读进度与当前章；点击展开目录并跳转，Escape或点外部关闭。
...
封面轻滑回归：2026-09-06，桌面Chromium原生wheel、手机Chromium原生触摸、手机WebKit程序滚动共9项专项通过，覆盖轻滑、中途停留、向下入口、接近正文对齐和底部继续滚动。WebKit自动化不等于iPhone原生惯性手势；真机结果待更新预览复测。证据在`resources/evidence/006-detail-reading/cover-proximity/`。
