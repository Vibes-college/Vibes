...
describes: '阅读作品详情'
status: 'current'
shaped-by: ['001', '003', '005', '006', '007', '008', '009', '010', '012']
code-sources:
  [
...
code-revision: '5a55e372fb65691c061053807d9398f572bce50aceb0f10b8dcefde6db05b40b'
---
...
H隔离实验站在作品页仍显示[本地助手](local-assistant.md)入口，收起及站内换篇保留原生实例；默认构建不启用。助手内输入和路由由独立容器处理。用户可主动附带当前公开作品，资料进入可编辑的原生草稿，发送前可取消；换篇不覆盖已有输入，完整路径见助手说明。
