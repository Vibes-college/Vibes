...
code-revision: '9803be9603b62f915cbbf8d26a89a66e8e8835c7b10031b86d2b9a9dd0910066'
---
...
- 视频与音频：点播放/试听后加载完整来源，可用原生播放/暂停、进度、音量与字幕控制，页面按钮同步状态；封面左上角的列表图标展开章节和文字稿，可直接跳转；跳转尚未完成时也可暂停，暂停会取消为跳转发起的补充下载，跳转结束后保持暂停；结束后可用原生按钮继续播放。音频波形来自实际录音，若附文字稿可展开阅读，带时间的行可跳转；没有歌词或字幕时不会生成假内容。Sintel是完整预告片，不是整部电影；Carefree提供完整录音。
