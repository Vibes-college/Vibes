...
- [x] 2026-09-20最终修正后的完整verify通过188项单元、377项浏览器及7项设备条件跳过；生产构建预算、产物核验与六份当前源码对应的site回执通过。媒体专项本机46项通过/2项跳过、Linux15项通过/1项触摸注入条件跳过，另有12项气泡/键盘与42项页面身份/缓存专项通过。证据在resources/evidence/018-great-ui-scale/release-2026-09-19；2026-09-19记录保留为原版本证据。
