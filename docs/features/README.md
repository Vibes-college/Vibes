...
| [阅读作品详情](article-read.md)     | 作品卡片或 /{locale}/works/{id}/         | current | 001, 003, 005, 006, 007, 008, 009 |

## 维护者维护网站

| 要完成的事情                                 | 入口                               | status  | shaped-by                    |
| -------------------------------------------- | ---------------------------------- | ------- | ---------------------------- |
| [维护作品内容](content-maintenance.md)       | 让AI编辑作品文件，再校验原文与译文 | current | 001, 003, 008, 009           |
| [检查与发布网站](project-commands.md)        | 检查改动、提交审阅、获准发布与恢复 | current | 001, 002, 003, 004, 005, 009 |
