...
| ----------------------------------- | ---------------------------------------- | ------- | ------------------------------------------- |
| [浏览与搜索作品](explore-browse.md) | /zh/ 或 /en/：浏览、分类、搜索，再点卡片 | current | 001, 003, 005, 010, 011                     |
| [阅读作品详情](article-read.md)     | 作品卡片或 /{locale}/works/{id}/         | current | 001, 003, 005, 006, 007, 008, 009, 010, 011 |
| [使用本地助手](local-assistant.md)  | 首页或详情右下角：连接自己的电脑Agent    | current | 011                                         |
...
| [检查与发布网站](project-commands.md)        | 检查改动、提交审阅、获准发布与恢复 | current | 001, 002, 003, 004, 005, 009, 010, 011 |
