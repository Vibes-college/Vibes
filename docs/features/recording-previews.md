...
code-revision: 'c3353be1ebbd8a696439151d9cb4938b56366f4166bc75b1da796902c3f4f337'
---
...
- [x] 2026-09-15独立入口69项通过，覆盖三浏览器48件真实播放；126个独立MP4完整解码通过。媒体专项36项通过、6项设备跳过，覆盖暂停、有效放大、旋转、按需请求、无分段定位、失败及卸载清理。
- [x] 2026-09-15正式站完整回归340项通过、11项设备跳过，匹配当前实现的site回执与Cloudflare阶段预览核验通过；内置浏览器另核对桌面与390px手机三类样板、合集切换、有效放大和实际播放。非真机验收。
