...
- [x] 2026-09-20最终修正后的完整verify通过377项浏览器及7项设备条件跳过，生产构建预算、产物核验与六份当前源码对应的site回执通过。媒体专项本机46项通过/2项跳过、Linux15项通过/1项触摸注入条件跳过。证据在resources/evidence/018-great-ui-scale/release-2026-09-19；2026-09-19记录及Cloudflare阶段预览的桌面/390px操作证据保留，非真机验收。最终Linux CI和上线凭据在PR维护。
