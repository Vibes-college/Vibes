...
合集轻量索引直接随其有限分页HTML或Pagefind卡片数据交付，没有独立合集接口；浏览器只下载当前成员的短片。详情的recordingMedia提供桌面及可选手机素材，任务media.url为桌面绝对地址，手机素材不同则带mobileUrl。学习页以800px为断点选一份高清录屏，不同时预载两份。
