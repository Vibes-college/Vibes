...
code-revision: '1ef61dac3f47038e675705867f30c7cc1578e855f7855fdf4ed5967cd62c0eb9'
---
...
| 正文16px/1.85；标题18–20px，进度目录14px    | 接近正文才初始化，底部胶囊仅在正文出现，500ms尺寸回弹、220ms文字交叉淡入、目录逐项显示及圆环追随；减少动态偏好即时完成 | src/styles/article.css；src/styles/detail.css；src/scripts/reading-progress.ts |
